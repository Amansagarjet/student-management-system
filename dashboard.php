...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
      <a class="nav-link mx-4 text-dark">Hii, <?php echo $_SESSION['user']; ?></a>
      </li>
        <li class="nav-item">
...
<div class="row">
  ...
  <div class="col-md-4 col-lg-4">
  <center><a href="update.php"><img src="assets/img/edit.png" alt="View Student image" style="height:250px;"></a></center>
  </div>
</div>
<br>
...
<div class="row">
  ...
  <div class="col-md-4 col-lg-4">
      <a href="update.php"><center><button class="btn btn-primary">Edit Student Details</button></center></a>
  </div>
</div>
  </body>
</html>